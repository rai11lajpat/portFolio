      ...
      <div className="flex items-center space-x-2 mt-10">
        ...
        <div className="flex justify-center">
          <div className="flex space-x-3 flex-wrap w-4/3 justify-center">
            ...
            <p className="px-5 py-3 bg-gray-300 w-fit rounded-full mt-2 hover:bg-orange-500 cursor-pointer">Oracle</p>
           
            <p className="px-5 py-3 bg-gray-300 w-fit rounded-full mt-2 hover:bg-orange-500 cursor-pointer">spring boot</p>
            <p className="px-5 py-3 bg-gray-300 w-fit rounded-full mt-2 hover:bg-orange-500 cursor-pointer">Docker</p>
            <p className="px-5 py-3 bg-gray-300 w-fit rounded-full mt-2 hover:bg-orange-500 cursor-pointer">Maven</p>
            ...
            <p className="px-5 py-3 bg-gray-300 w-fit rounded-full mt-2 hover:bg-orange-500 cursor-pointer">Git</p>
